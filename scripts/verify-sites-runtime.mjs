...
const local = JSON.parse(fs.readFileSync(new URL('../out/dist/client/_sites/runtime-integrity.json', import.meta.url)));
...
const nodes = JSON.parse(fs.readFileSync(new URL('../out/dist/client/data/panoramas-online.json', import.meta.url))).nodes;
