...
def validate(project):
 ...
 removed=[3199, 3201, 3202, 3207, 3208, 3211, 3212, 3213];checks={}
 ...
 return {'pass':True,'trianglesBefore':sum(len(x['POSITION'])for x in aa),'trianglesAfter':sum(len(x['POSITION'])for x in bb),'removedTriangles':8,**checks,'imagesByteEquivalent':True,'materialsNodesTransformsUnchanged':True,'manifestHashAndTileBinding':True}
