...
import numpy as np
TILE='12-NW-11A/12-NW-11A-4/Tile_303_143_L16_0'
SOURCE_SHA='86048c48599b423407c7946ad0d452a9b1a12d55e88791a7b7f884f1d7d618c1'
REMOVE_GLOBAL=[3199, 3201, 3202, 3207, 3208, 3211, 3212, 3213]
...
def build(src,dest):
 ...
 g['asset'].setdefault('extras',{})['sourceCorrection']={'id':'ug12-isolated-photogrammetry-fragment-8','sourcePreviewSha256':SOURCE_SHA,'removedSourceGlobalTriangleIndices':REMOVE_GLOBAL,'scope':'Only positively identified disconnected source fragment. No roof/height-based blanket removal.'}
